      ...
      <div className="bg-brand-black text-brand-white pt-24 pb-8">
        <div className="max-w-7xl mx-auto px-4 md:px-8">
          <div className="flex items-center gap-2 text-sm text-brand-white/60 mb-6 font-mono">
            <Link href={`/${lang}`} className="hover:text-brand-white transition-colors">Home</Link>
            <ChevronRight className="w-4 h-4" />
            <Link href={`/${lang}/demands`} className="hover:text-brand-white transition-colors">Demands</Link>
            <ChevronRight className="w-4 h-4" />
          ...
          <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-8">
            ...
            <div className="shrink-0 flex gap-4">
              ...
              {process.env.PUBLIC_APPLICATIONS_ENABLED === 'true' && demand.enableApplication && !isClosed && (
                <Link
                  href={`/${lang}/demands/${demand.slug}/apply`}
      ...
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-12">
        ...
        <div className="mb-16">
          ...
          <div className="hidden lg:block">
            <DemandPositionTable demand={demand} lang={lang} />
          </div>
          <div className="block lg:hidden">
            <DemandPositionCards demand={demand} lang={lang} />
          </div>
